...
export default function AboutPage() {
  return (
    <main className="bg-[#080808] text-white"><PageHeader /><PageIntro eyebrow="About Diction" title="For founders who deserve to be known." description="Diction helps credible founders and experts turn what they know into a clear, trusted and opportunity-generating digital presence without performing for every platform." primary={{ label: "Explore the framework", href: "#framework" }} secondary={{ label: "See capabilities", href: "/capabilities" }} backgroundImage={{ src: "/hero-about-founder.png", alt: "Founder in a creative studio" }} />
