      ...
      {backgroundImage ? (
        <div className="page-intro-background" aria-hidden="true">
          <Image
            ...
            style={backgroundImage.position ? { objectPosition: backgroundImage.position } : undefined}
            sizes="100vw"
          />
        </div>
      ) : null}
